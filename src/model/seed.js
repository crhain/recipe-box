...
export default [
  {
    ...
    image:
      'https://tiphero.com/wp-content/uploads/2017/05/easy-beef-stroganoff-FI-750x364.jpg',
    servings: 4,
    ingredients: [
      ...
      { quantity: 0.5, measure: 'cup', ingredient: 'butter' },
      {
        quantity: 1.5,
        measure: 'cups',
        ingredient: 'Progresso, beef flavored broth'
      },
    ...
    ingredients: [
      {
        quantity: 1.25,
        measure: 'pounds',
        ingredient: 'Johnsonville Ground Mild Italian sausage'
      },
      ...
      {
        quantity: 1,
        measure: 'can (28 ounces)',
        ingredient: 'crushed tomatoes'
      },
      {
        quantity: 1,
        measure: 'can (15 ounces)',
        ingredient: 'crushed tomatoes'
      },
      ...
      { quantity: 2, measure: 'tablespoons', ingredient: 'sugar' },
      {
        quantity: 3,
        measure: 'tablespoons',
        ingredient: 'minced fresh parsley, divided'
      },
      {
        quantity: 0.25,
        measure: 'cup',
      ...
      {
        quantity: 1,
        measure: 'carton (15 ounces)',
        ingredient: 'ricotta cheese'
      },
      {
        quantity: 4,
        measure: 'cups',
        ingredient: 'shredded part-skim mozzarella cheese'
      },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { quantity: 1, measure: 'regular', ingredient: 'garlic clove, minced' },
      {
        quantity: 2,
        measure: 'cups',
        ingredient: 'medium or long-grain white rice'
      },
